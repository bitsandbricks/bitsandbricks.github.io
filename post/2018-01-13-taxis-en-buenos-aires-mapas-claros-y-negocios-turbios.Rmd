...
ggplot() +
   geom_polygon(data = calles,
    ...
    labs(title="Taxis en Buenos Aires: origen y destino",
...
Dicho esto, algunos puntitos verdes que asoman en ambos sitios demuestran que existen taxistas osados -o muy distraídos- que se han llevado pasajeros en las narices de la mafia.
...
## Por último: qué pasa con las otras tres zonas donde los taxis llevan pasajeros pero rara vez los levantan?
